...
}, goog.findBasePath_(), goog.global.CLOSURE_NO_DEPS || goog.importScript_("plugins/ol/4.6.5/ol-deps.js")), goog.typeOf = function(t) {
	var o = typeof t;
	if("object" == o) {
		if(!t) return "null";
...
"object" == typeof module && "object" == typeof module.exports ? module.exports = P : "function" == typeof define && define.amd && define(P), "undefined" != typeof window && expose(), P.Constants = {
	...
	this.deactivate(), this.deactivateMapTools(), map.on("click", this.mapFirstClickHandler, this), this.plotType = t, this.plotParams = o, this.map.addLayer(this.drawOverlay)
	...
	null != this.dblClickZoomInteraction && (map.getInteractions().push(this.dblClickZoomInteraction), this.dblClickZoomInteraction = null)
	...
	if(t && t instanceof ol.Feature && t != this.activePlot) {
		var o = t.getGeometry();
		o.isPlot() && (this.deactivate(), this.activePlot = t, this.map.on("pointermove", this.plotMouseOverOutHandler, this), this.initHelperDom(), this.initControlPoints())
	}
